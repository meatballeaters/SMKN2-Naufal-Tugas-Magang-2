...
class Records {
	...
	public function listRecords(){
		...
		while ($record = $result->fetch_assoc()) {
			...
			$rows[] = $record['bayar'];
			$rows[] = $record['status'];
			$rows[] = '<button type="button" name="update" id="'.$record["id"].'" class="btn btn-warning text-light btn-xs update">Update</button>';
			$rows[] = '<button type="button" name="delete" id="'.$record["id"].'" class="btn btn-danger text-light btn-xs delete" >Delete</button>';
			$records[] = $rows;
		}
